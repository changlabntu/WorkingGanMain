...
class GAN(BaseModel):
    def __init__(self, hparams, train_loader, test_loader, checkpoints):
        ...
        from networks.networks_srgan import SRResNet, DiscriminatorX8
        self.net_g = SRResNet(self.hparams.scale_factor, 64, 16)
        self.net_d = DiscriminatorX8(65)
        ...
        self.criterion_VGG = VGGLoss(net_type='vgg19', layer='relu2_2')#='relu5_4')
    ...
    def generation(self, batch):
        img = batch['img']
        ori = img[0]
        self.oriX = nn.Upsample(size=(32, 32))(ori)
...
# CUDA_VISIBLE_DEVICES=0,1 python train.py --jsn wbc --prj srgan/scale4_DX8 --direction hr -b 64 --env t09b --scale_factor 4 --models srgan
