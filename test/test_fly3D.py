...
def sum_all(source):
    #source = '/media/ghc/GHc_data2/N3D/z4trd/xyzorix4/'
    #source = '/media/ghc/GHc_data2/N3D/oz1trdx4/xyzorix4/'
    ...
    #tifs = (tifs > -0.58)
    #v = np.var(tifs, 3)
    #tiff.imwrite(source + 'var.tif', v.astype(np.float16))
...
def make_rotation_3d(stepx, stepy, crop=True):
    stepx = 2
    stepy = 0
    # get model
...
if __name__ == '__main__':
    ...
    if 0:
        ...
        args.prj = 'cyc4_0523/z6trd'
        args.direction = 'xyzft0x6_xyzorix6'
        args.destination = '/media/ghc/GHc_data2/N3D/z6trd/'
        args.trd = [5, 2000]
        args.epoch = range(120, 121, 10)
        args.env = 't09b'
        args.angle_range = list(range(120, 360, 30))
        ...
        args.env = 't09b'
        args.angle_range = list(range(0, 1, 30))
    elif 0:  # For the two-parts subsampled
        args.dataset = 'Fly0B'
        ...
        args.prj = 'cyc4_0523/z1trd'
        args.direction = 'xyzft0_xyzori'
        args.destination = '/media/ghc/GHc_data2/N3D/z1trdtest/'
        args.trd = [5, 2000]
        args.epoch = range(120, 121, 10)
        args.env = 't09b'
        args.angle_range = [30, 330]
    elif 1:  # for the original subsampled
        args.prj = 'cyc4_1024/cutFoo'
        args.direction = 'xyzori_xyzori'
        args.destination = '/media/ghc/GHc_data2/N3D2/cutFoo/'
        args.trd = [2000, 2000]
        args.epoch = [100]#range(10, 201, 10)#range(40, 41, 10)
        args.env = 't09b'
        args.angle_range = list(range(210, 360, 30))
