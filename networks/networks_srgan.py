...
class SRResNet(nn.Module):
    ...
    def __init__(self, scale_factor=4, ngf=64, n_blocks=16):  # ngf: number of generator filters
...
class DiscriminatorX8(nn.Sequential):
    """
    Discriminator for SRGAN.
    Dense layers are replaced with global poolings and 1x1 convolutions.
    """
    ...
    def __init__(self, ndf):
        ...
        super(DiscriminatorX8, self).__init__(
            nn.Conv2d(3, ndf, 3, stride=1, padding=1),
            nn.LeakyReLU(0.2, True),
