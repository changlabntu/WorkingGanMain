...
#net = ViTVNet(CONFIGS['ViT-V-Net'], img_size=(64, 256, 256), int_steps=7, vis=False)
t = Transformer(CONFIGS['ViT-V-Net'], img_size=(64, 256, 256), vis=False)
num_of_parameters = sum(p.numel() for p in t.parameters() if p.requires_grad)
o = t(torch.randn(1, 1, 64, 256, 256))