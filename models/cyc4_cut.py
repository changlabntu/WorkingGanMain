...
class GAN(BaseModel):
    def __init__(self, hparams, train_loader, test_loader, checkpoints):
        ...
        # save model names
        self.netg_names = {'net_gXY': 'netGXY', 'net_gYX': 'netGYX', 'netF': 'netF'}
...
#CUDA_VISIBLE_DEVICES=0,1 python train.py --jsn wnwp3d --prj cyc4_1024/cut0 --models cyc4_cut -b 16 --direction zyft0_zyori%xyft0_xyori --trd 2000 --nm 11 --netG descarnoumc --mc --split all --env t09